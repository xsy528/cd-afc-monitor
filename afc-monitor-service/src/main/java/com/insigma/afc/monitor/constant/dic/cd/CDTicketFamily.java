package com.insigma.afc.monitor.constant.dic.cd;
 ...
 * @Time on 2019/8/27 10:29.
 * @Ticket :
*/

@Dic(overClass = CDTicketFamily.class)
public class CDTicketFamily extends Definition {

    private static CDTicketFamily instance = new CDTicketFamily();

    public static CDTicketFamily getInstance() {
        return instance;
    }
    ...
    //自定义类型，默认类型
    @DicItem(name = "默认类型", group = "")
    public static Integer DEFAULT_TICKET = 0;
}
