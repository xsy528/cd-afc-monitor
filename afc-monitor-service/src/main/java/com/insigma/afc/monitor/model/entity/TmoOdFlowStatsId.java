...
public class TmoOdFlowStatsId implements java.io.Serializable {
	...
	/** full constructor */
	public TmoOdFlowStatsId(Short lineId, Integer stationId,
                            Date gatheringDate, Integer timeIntervalId, Short ticketFamily) {
		this.lineId = lineId;
	...
	public boolean equals(Object other) {
		...
		return ((this.getLineId() == castOther.getLineId()) || (this
				...
				&& ((this.getGatheringDate() == castOther.getGatheringDate()) || (this
						.getGatheringDate() != null
						&& castOther.getGatheringDate() != null && this
						.getGatheringDate()
						.equals(castOther.getGatheringDate())))
				&& ((this.getTimeIntervalId() == castOther.getTimeIntervalId()) || (this
						.getTimeIntervalId() != null
						&& castOther.getTimeIntervalId() != null && this
						.getTimeIntervalId().equals(
								castOther.getTimeIntervalId())))
				&& ((this.getTicketFamily() == castOther.getTicketFamily()) || (this
						.getTicketFamily() != null
						&& castOther.getTicketFamily() != null && this
						.getTicketFamily().equals(castOther.getTicketFamily())));
	}
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGatheringDate() == null ? 0 : this.getGatheringDate()
						.hashCode());
		result = 37
				* result
				+ (getTimeIntervalId() == null ? 0 : this.getTimeIntervalId()
						.hashCode());
		result = 37
				* result
				+ (getTicketFamily() == null ? 0 : this.getTicketFamily()
						.hashCode());
		return result;
	}
