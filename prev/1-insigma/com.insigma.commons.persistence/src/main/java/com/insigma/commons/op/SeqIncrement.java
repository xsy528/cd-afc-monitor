 ...
 * @version 1.0
 */
public final class SeqIncrement implements IdentifierGenerator, Configurable {

	private static final Log log = LogFactory.getLog(SeqIncrement.class);
	 ...
	 *      generate(net.sf.hibernate.engine.SessionImplementor,
	 *      java.lang.Object)
	 */
