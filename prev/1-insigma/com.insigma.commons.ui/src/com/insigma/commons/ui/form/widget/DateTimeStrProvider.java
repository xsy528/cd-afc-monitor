...
import com.insigma.commons.ui.widgets.DateTimeStrPicker;
 ...
 *
 */
public class DateTimeStrProvider implements IWidgetProvider {
	...
	public IInputControl create(Composite parent, BeanField beanField) {
		...
		DateTimeStrPicker control = new DateTimeStrPicker(parent, SWT.NONE);
		if (value != null) {
