...
public class CheckableCellRenderer extends DefaultCellRenderer {
	 ...
	 * can be found in the folder images/ and are named 
	...
	public static final Image IMAGE_CHECKED = SWTX.loadImageResource(Display.getCurrent(), "images/checked.gif");

	/** Indicator for an unchecked entry / false boolean decision */
	public static final Image IMAGE_UNCHECKED = SWTX.loadImageResource(Display.getCurrent(), "images/unchecked.gif");
	...
	protected void drawImage(GC gc, Rectangle rect, Image image, Color backgroundColor) {
		...
		SWTX.drawTextImage(gc, "", getAlignment(), image, getAlignment(), rect.x + 3, rect.y, rect.width - 3,
				rect.height);
	}
