 ...
 *
 */
public class DateStrPicker extends EnhanceComposite implements IInputControl {
	...
	public DateStrPicker(Composite parent, int style) {
	...
	public Object getObjectValue() {
		...
		if (!dateText.getText().equals("")) {
			...
			return DateTimeUtil.formatDate(dat, "yyyyMMdd");
		}
	}
	...
	public void setObjectValue(Object objectValue) {
		if (objectValue instanceof Date) {
			...
			if (objectValue.equals("")) {
				objectValue = new SimpleDateFormat("yyyyMMdd").format(new Date());
			}
			dateText.setText(objectValue.toString());
		}
	}
