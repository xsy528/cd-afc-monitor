...
public class DefaultCellRenderer implements KTableCellRenderer {
	...
	public static final FixedCellRenderer m_FixedRenderer = new FixedCellRenderer(STYLE_FLAT);
	public static final TextCellRenderer m_TextRenderer = new TextCellRenderer(INDICATION_FOCUS);
