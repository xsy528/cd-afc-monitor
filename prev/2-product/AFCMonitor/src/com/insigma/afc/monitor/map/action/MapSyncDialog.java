...
public class MapSyncDialog extends TreeDialog {
	...
	public MapSyncDialog(EditorFrameWork parent, int style) {
	...
	class MapSyncActionHandler extends CommandActionHandler {
		...
		public void perform(final ActionContext context) {
			...
			if (command.isOK) {
				send(context, CommandType.CMD_SYNC_MAP, "地图同步命令", null, ids, cmdType);
			} else {
