 ...
 */
@Entity
@Table(name = "TMO_EQU_MODULE")
@SequenceGenerator(name = "SEQ_GEN", sequenceName = "S_TMO_MODE_UPLOAD_INFO", allocationSize = 1, initialValue = 1)
public class TmoModuleStatusHistory implements java.io.Serializable {

	private static final long serialVersionUID = -36589800201580336L;
	...
	/** default constructor */
	public TmoModuleStatusHistory() {
	}

	/** minimal constructor */
	public TmoModuleStatusHistory(long eventId) {
		this.eventId = eventId;
	}

	public TmoModuleStatusHistory(long eventId, long nodeId, short lineId, int stationId, short equType, int tagId,
