...
import com.insigma.afc.ui.widgets.TimeSectionSelection;
...
public class TimeSectionProvider implements IWidgetProvider {
	...
	public IInputControl create(Composite parent, BeanField beanField) {
		...
		TimeSectionSelection control = new TimeSectionSelection(parent, SWT.BORDER);
