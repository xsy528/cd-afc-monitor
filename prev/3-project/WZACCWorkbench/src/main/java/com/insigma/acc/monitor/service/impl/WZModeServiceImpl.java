...
import com.insigma.acc.monitor.service.AbstarctModeService;
import com.insigma.acc.monitor.service.IWZModeService;
...
public class WZModeServiceImpl extends AbstarctModeService implements IWZModeService {
	...
	/* (non-Javadoc)
	 * @see com.insigma.acc.monitor.service.IWZModeService#handleModeBroadcast(java.util.List)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.insigma.acc.monitor.service.IWZModeService#getModeSearchList(java.lang.Short, java.lang.Short, java.util.Date, java.util.Date, int, int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.insigma.acc.monitor.service.IWZModeService#getModeSearchCount(java.lang.Short, java.lang.Short, java.util.Date, java.util.Date)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.insigma.acc.monitor.service.IWZModeService#getMetroNodeList()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.insigma.acc.monitor.service.IWZModeService#saveOrUpdateOnlineStatus(short, int, long, short)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.insigma.acc.monitor.service.IWZModeService#getAbnormalTmoModeUploadInfo()
	 */
	@Override
	public List<TmoModeUploadInfo> getAbnormalTmoModeUploadInfo() {
		return null;
	...
	/* (non-Javadoc)
	 * @see com.insigma.acc.monitor.service.IWZModeService#getTmoItemMode(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.insigma.acc.monitor.service.IWZModeService#getDeviceTmoItemMode(short, int)
	 */
	@Override
	public List<TmoItemStatus> getDeviceTmoItemMode(short lindID, int stationID) {
	...
	/* (non-Javadoc)
	 * @see com.insigma.acc.monitor.service.IWZModeService#getCurTmoItemMode(int)
	 */
	@Override
