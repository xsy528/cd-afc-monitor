...
enum EODComponentType_t {                       
	...
	EOD_PCA				        = 0x2D, /* EOD: PCA参数 */
        EOD_SLESOFTWARE                         = 0x2E, /* EOD: 设备软件参数 */
        EOD_TPSOFTWARE                          = 0x2F  /* EOD: TP软件参数 */
};
...
enum FileHeaderTag_t {                          
	...
	FILE_EOD_PCA			       = 0x2D,  /* EOD: PCA参数文件 */
        FILE_SLESOFTWARE                       = 0x2E,  /* EOD: 设备软件程序参数文件 */
	FILE_TPSOFTWARE                        = 0x2F,  /* EOD: TP软件程序参数文件 */
	...
	FILE_TRANS_ACCOUNT                     = 0x62,  /* 交易对账文件 */
	FILE_DOUBTFULDEAL_RESULT               = 0x63,  /* 可疑交易处理文件 */
	FILE_COMPARISON_WITH_YKT               = 0x64,  /* 与市民卡对账文件 */
	FILE_COMPARISON_WITH_MOBILE            = 0x65,  /* 与移动对账文件 */
	FILE_COMPARISON_WITH_BANK              = 0x66   /* 与银联对账文件 */
};
