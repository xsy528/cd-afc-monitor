...
%*   2018/03/16    *    华科峰           *     1.4.？ESLogin_Ans_t，OperatorLogin_Ans_t，Task_Ans_t结构添加应答码字段
%*   2018/03/16    *    华科峰           *     1.4.？SVTInitComm_t结构新增InitBatchCode字段
%**************************************************************************************************************/
...
struct OperatorLogin_Ans_t{
        MACK_t                                  MackCode;			/* 应答码 */
	UnicodeString_t                         OperatorName;			/* 操作员姓名 */
