...
struct UploadTicketIncome_Req_t{
	...
	string                                  BankCode<32>;               /* 银行编码 */
        StationID_t                             SpareGoldAllocation;        /* 备用金来源/去向 */ 
...
struct SleCashList_t{
	...
	DeviceID_t                              DeviceID;                       /* 设备编号 */
        U32_t                                  	AddCoinMoney;                   /* 硬币补币金额 */
        U32_t                                  	AddNoteMoney;                   /* 纸币补币金额 */
        U32_t                                  	PointMoney;                   	/* 实点金额 */
        U32_t                                   ReceiptMoney;                   /* 实收金额 */
...
struct UploadSellerStatements_Req_t{
	...
	OperatorID_t                            AuditorID;	            /* 审核人员编号 */
        ...
        U32_t                                   SpareGoldUseMoney;          /* 备用金领用金额 */
	U32_t                                   TransactionValue;           /* 充值金额 */
	U32_t                                   SurchargeValue;             /* 更新金额 */
	U32_t                                   RefundValue;                /* 退款金额 */
	U32_t                                   SpecialIncome;              /* 特殊收入 */
	U32_t                                   StatementsMoney;            /* 交班金额 */
...
struct UploadStationRevenuedaily_Req_t{
	...
	AFCTime64_t                             UploadTime;                 /* 上传时间 */
        StationID_t                             StationID;                  /* 车站编号 */  	
        Date2_t				        BusinessDate;		    /* 运营日 */
        U32_t                                   YesterdayBankMoney;         /* 前日解行票款 */
	U32_t                                   YesterdayRetainMoney;       /* 前日留存票款 */
	U32_t                                   TodayBankMoney;             /* 本日解行票款 */
	U32_t                                   TodayRetainMoney;           /* 本日留存票款 */
	U32_t                                   BankFillingMoney;           /* 解行补交票款 */
	U32_t                                   SpecialIncome;              /* 特殊收入 */
	U32_t                                   IsmIncome;                  /* ISM合计收入 */
	U32_t                                   TvmIncome;                  /* TVM合计收入 */
	U32_t                                   BomIncome;                  /* BOM合计收入 */
	U32_t                                   IsmFillingMoney;            /* ISM补短款收入 */
	U32_t                                   TvmFillingMoney;            /* TVM补短款收入 */
	U32_t                                   BomFillingMoney;            /* BOM补短款收入 */
	U32_t                                   SpareGoldRetain;            /* 备用金留存 */
	U32_t                                   DiffMoney;                  /* 差额 */
