...
import com.insigma.acc.wz.xdr.message.req.BOMAddValueAffirm_Req_t;
import com.insigma.acc.wz.xdr.message.req.BOMAddValueAffirm_Req_t_Decoder;
import com.insigma.acc.wz.xdr.message.req.BOMAddValueAffirm_Req_t_Encoder;
 ...
 *
 */
public class TestBOMAddValueAffirm_Req_t {

	public static void main(String[] args) {
		TestBOMAddValueAffirm_Req_t bomAddValueAffirm = new TestBOMAddValueAffirm_Req_t();
		bomAddValueAffirm.testModel();
	}
	...
	private void testModel() {
		...
		BOMAddValueAffirm_Req_t file = generateBean();
		...
		// decode
		BOMAddValueAffirm_Req_t file_t = fileDecode(filePath, fileName);

		// 反向encode
		fileEncoder(filePath, fileName2, file_t);

		// 反向decode
		BOMAddValueAffirm_Req_t file_t2 = fileDecode(filePath, fileName2);
	...
	private BOMAddValueAffirm_Req_t fileDecode(String filePath, String fileName) {
		...
		try {
			...
			BOMAddValueAffirm_Req_t file1 = new BOMAddValueAffirm_Req_t_Decoder().decode(decoder);
			return file1;
		} catch (Exception e) {
			e.printStackTrace();
		} finally {
	...
	private void fileEncoder(String filePath, String fileName, BOMAddValueAffirm_Req_t file) {
		...
		try {
			...
			new BOMAddValueAffirm_Req_t_Encoder().encode(encoder, file);
		} catch (Exception e) {
			e.printStackTrace();
		} finally {
			if (out != null) {
	...
	private BOMAddValueAffirm_Req_t generateBean() {
		//test:
		BOMAddValueAffirm_Req_t dataFile_t = new BOMAddValueAffirm_Req_t();
