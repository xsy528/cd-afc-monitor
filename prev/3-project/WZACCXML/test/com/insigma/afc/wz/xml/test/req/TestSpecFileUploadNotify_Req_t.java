...
import com.insigma.acc.wz.xdr.message.req.SpecFileUploadNotify_Req_t;
import com.insigma.acc.wz.xdr.message.req.SpecFileUploadNotify_Req_t_Decoder;
import com.insigma.acc.wz.xdr.message.req.SpecFileUploadNotify_Req_t_Encoder;
 ...
 * 
 */
public class TestSpecFileUploadNotify_Req_t {
	public static void main(String[] args) {
		TestSpecFileUploadNotify_Req_t specFileUploadNotify = new TestSpecFileUploadNotify_Req_t();
		specFileUploadNotify.testModel();
	}
	...
	private void testModel() {
		...
		SpecFileUploadNotify_Req_t file = generateBean();
		...
		// decode
		SpecFileUploadNotify_Req_t file_t = fileDecode(filePath, fileName);

		// 反向encode
		fileEncoder(filePath, fileName2, file_t);

		// 反向decode
		SpecFileUploadNotify_Req_t file_t2 = fileDecode(filePath, fileName2);
	...
	private SpecFileUploadNotify_Req_t fileDecode(String filePath, String fileName) {
		...
		try {
			...
			SpecFileUploadNotify_Req_t file1 = new SpecFileUploadNotify_Req_t_Decoder().decode(decoder);
			return file1;
		} catch (Exception e) {
			e.printStackTrace();
		} finally {
	...
	private void fileEncoder(String filePath, String fileName, SpecFileUploadNotify_Req_t file) {
		...
		try {
			...
			new SpecFileUploadNotify_Req_t_Encoder().encode(encoder, file);
		} catch (Exception e) {
			e.printStackTrace();
		} finally {
			if (out != null) {
	...
	private SpecFileUploadNotify_Req_t generateBean() {
		//test:
		SpecFileUploadNotify_Req_t dataFile_t = new SpecFileUploadNotify_Req_t();
