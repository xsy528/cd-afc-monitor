...
import com.insigma.acc.wz.xdr.message.req.Station_Maintain_Affirm_Req_t;
import com.insigma.acc.wz.xdr.message.req.Station_Maintain_Affirm_Req_t_Decoder;
import com.insigma.acc.wz.xdr.message.req.Station_Maintain_Affirm_Req_t_Encoder;
 ...
 *
 */
public class TestStation_Maintain_Affirm_Req_t {

	public static void main(String[] args) {
		TestStation_Maintain_Affirm_Req_t stationMaintainAffirm = new TestStation_Maintain_Affirm_Req_t();
		stationMaintainAffirm.testModel();
	}
	...
	private void testModel() {
		...
		Station_Maintain_Affirm_Req_t file = generateBean();
		...
		// decode
		Station_Maintain_Affirm_Req_t file_t = fileDecode(filePath, fileName);

		// 反向encode
		fileEncoder(filePath, fileName2, file_t);

		// 反向decode
		Station_Maintain_Affirm_Req_t file_t2 = fileDecode(filePath, fileName2);
	...
	private Station_Maintain_Affirm_Req_t fileDecode(String filePath, String fileName) {
		...
		try {
			...
			Station_Maintain_Affirm_Req_t file1 = new Station_Maintain_Affirm_Req_t_Decoder().decode(decoder);
			return file1;
		} catch (Exception e) {
			e.printStackTrace();
		} finally {
	...
	private void fileEncoder(String filePath, String fileName, Station_Maintain_Affirm_Req_t file) {
		...
		try {
			...
			new Station_Maintain_Affirm_Req_t_Encoder().encode(encoder, file);
		} catch (Exception e) {
			e.printStackTrace();
		} finally {
			if (out != null) {
	...
	private Station_Maintain_Affirm_Req_t generateBean() {
		//test:
		Station_Maintain_Affirm_Req_t dataFile_t = new Station_Maintain_Affirm_Req_t();
