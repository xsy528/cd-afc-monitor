...
import com.insigma.acc.wz.xdr.message.req.UploadTicketStockNotify_Req_t;
import com.insigma.acc.wz.xdr.message.req.UploadTicketStockNotify_Req_t_Decoder;
import com.insigma.acc.wz.xdr.message.req.UploadTicketStockNotify_Req_t_Encoder;
 ...
 * 
 */
public class TestUploadTicketStockNotify_Req_t {
	public static void main(String[] args) {
		TestUploadTicketStockNotify_Req_t uploadTicketStockNotify = new TestUploadTicketStockNotify_Req_t();
		uploadTicketStockNotify.testModel();
	}
	...
	private void testModel() {
		...
		UploadTicketStockNotify_Req_t file = generateBean();
		...
		// decode
		UploadTicketStockNotify_Req_t file_t = fileDecode(filePath, fileName);

		// 反向encode
		fileEncoder(filePath, fileName2, file_t);

		// 反向decode
		UploadTicketStockNotify_Req_t file_t2 = fileDecode(filePath, fileName2);
	...
	private UploadTicketStockNotify_Req_t fileDecode(String filePath, String fileName) {
		...
		try {
			...
			UploadTicketStockNotify_Req_t file1 = new UploadTicketStockNotify_Req_t_Decoder().decode(decoder);
			return file1;
		} catch (Exception e) {
			e.printStackTrace();
		} finally {
	...
	private void fileEncoder(String filePath, String fileName, UploadTicketStockNotify_Req_t file) {
		...
		try {
			...
			new UploadTicketStockNotify_Req_t_Encoder().encode(encoder, file);
		} catch (Exception e) {
			e.printStackTrace();
		} finally {
			if (out != null) {
	...
	private UploadTicketStockNotify_Req_t generateBean() {
		//test:
		UploadTicketStockNotify_Req_t dataFile_t = new UploadTicketStockNotify_Req_t();
