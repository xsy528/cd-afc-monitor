...
import com.insigma.acc.wz.monitor.dialog.WZMapSyncDialog;
...
public class WZMapSyncAction extends Action {
	...
	public class MapSyncActionHandler extends ActionHandlerAdapter {
		...
		public void perform(final ActionContext context) {
			WZMapSyncDialog dlg = new WZMapSyncDialog(context.getFrameWork(), SWT.NONE);
