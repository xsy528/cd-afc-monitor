...
import com.insigma.afc.monitor.search.TmoModeUploadViewItem;
...
public class WZModeUploadSearchActionHandler extends SearchActionHandlerAdapter {
	...
	public void perform(SearchRequest request, SearchResponse response) {
		...
		int totalNum = 0;
		try {
			WZModeUploadForm modeUploadForm = (WZModeUploadForm) request.getRequestValue();
